...
namespace CorpServe.Presistence.Migrations
{
    ...
    [Migration("20260326165711_Vendor-RequestProgressRelation")]
    partial class VendorRequestProgressRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CorpServe.Domain.Entities.ProposalModule.Proposal", b =>
                {
                    b.HasOne("CorpServe.Domain.Entities.RequestModule.Request", "Request")
                        .WithOne("Proposal")
                        .HasForeignKey("CorpServe.Domain.Entities.ProposalModule.Proposal", "RequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
